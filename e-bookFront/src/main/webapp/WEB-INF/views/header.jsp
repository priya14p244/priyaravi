	...
	<div class="container">
		<nav class="navbar navbar-default">
			<div class="navbar-header">
				<a href="" class=".navbar-nav"><img src="<c:url value='/resources/images/l.jpg'></c:url>" alt="NIIT" height="50px" width="150px"></a>
   ...
   data-toggle="collapse" data-target="#navbardemo" aria-expanded="false">
        ...
        <span class="icon-bar"></span>
			...
			<ul class="nav navbar-nav">
			   ...
			   <li><a href="<c:url value='/cart/getcart'></c:url>"><span class="glyphicon glyphicon-shopping-cart"> Cart</span></a></li>
			   </security:authorize>
